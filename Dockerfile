...
COPY --from=BUILD /app/cleave-zen-formatter-demo/target/cleave-zen-formatter-demo-1.0-SNAPSHOT.jar /app/
WORKDIR /app/
EXPOSE 8080
ENTRYPOINT java -jar cleave-zen-formatter-demo-1.0-SNAPSHOT.jar 8080