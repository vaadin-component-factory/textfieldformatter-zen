...
import org.vaadin.addons.cleavezenformatter.conf.FormatDateOptions;
...
// todo ?       getConfiguration().date = true;
    ...
    @Override
    protected FormatDateOptions createDefaultConfiguration() {
        return new FormatDateOptions();
    }
