...
import org.vaadin.addons.cleavezenformatter.conf.CleaveExtension;
import org.vaadin.addons.cleavezenformatter.conf.FormatGeneralOptions;
...
public class CustomStringBlockFormatter extends CleaveExtension<FormatGeneralOptions> {
	...
	private CustomStringBlockFormatter(int[] blocks, String[] delimiters, boolean lazyDelimiter, ForceCase forceCase,
		...
		// todo jcg getConfiguration().showPrefixImmediately = showPrefixImmediately;
	...
	@Override
	protected FormatGeneralOptions createDefaultConfiguration() {
		return new FormatGeneralOptions();
	}
